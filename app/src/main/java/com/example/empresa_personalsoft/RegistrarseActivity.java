...
public class RegistrarseActivity extends AppCompatActivity implements Response.Listener<JSONObject>,Response.ErrorListener {
    ...
    public void Consultar(View view) {
        ...
        if (usuario.isEmpty()) {
            ...
            url = "http://172.16.59.21:80/WebServices/consulta.php?usr=" + usuario;
    ...
    public void Adicionar(View view) {
        ...
        if (usuario.isEmpty() || nombre.isEmpty() || correo.isEmpty() || clave.isEmpty()) {
            ...
            url = "http://172.16.59.21:80/WebServices/registrocorreo.php";
        }
    ...
    public void Modificar(View view) {
        ...
        if (usuario.isEmpty() || nombre.isEmpty() || correo.isEmpty() || clave.isEmpty()) {
            ...
            url = "http://172.16.59.21:80/WebServices/actualiza.php";
        }
        StringRequest postRequest = new StringRequest(Request.Method.POST, url,
                new Response.Listener<String>() {
                    @Override
    ...
    public void Anular(View view) {
        ...
        if (usuario.isEmpty()) {
            ...
            url = "http://172.16.59.21:80/WebServices/anula.php";
        }
        StringRequest postRequest = new StringRequest(Request.Method.POST, url,
                new Response.Listener<String>() {
                    @Override
                ...
                new Response.ErrorListener() {
                    @Override
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(getApplicationContext(), "Eroor Anulando!", Toast.LENGTH_LONG).show();
                    }
                }
        ) {
            @Override
